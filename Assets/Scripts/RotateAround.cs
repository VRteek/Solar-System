...
public class RotateAround : MonoBehaviour {
	...
	void Update () {
        ...
        transform.RotateAround(centerMass.position, Vector3.up, Time.deltaTime * (defaultEarthYear / rotationAroundSunDays) * 3 * Time.deltaTime);

        transform.Rotate(-Vector3.up * Time.deltaTime * planetSpeedRotation * 3);
    }
