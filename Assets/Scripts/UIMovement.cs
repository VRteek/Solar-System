...
namespace VRStandardAssets.Utils {
    ...
    public class UIMovement : MonoBehaviour {
        ...
        private void Update () {
            ...
            // m_UIElement.Rotate (new Vector3 (90, 0, 0));
            ...
            if (m_RotateWithCamera) {
                ...
                Vector3 targetPosition = m_Camera.position + targetDirection * 10;
                ...
                m_UIElement.position = targetPosition+new Vector3(0,0,20);
            }
        }
    }
}